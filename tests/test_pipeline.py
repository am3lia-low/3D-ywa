...
def extraction_p1() -> ExtractionResult:
    ...
    observations = [
        ...
        observation("window", Predicate.HAS_PROPERTY, "P1-S3", property_name="height", value="tall"),
        ...
        observation("portrait", Predicate.HAS_PROPERTY, "P1-S4", property_name="frame", value="gilded"),
...
def extraction_p4() -> ExtractionResult:
    ...
    return ExtractionResult(
        ...
        observations=[
            ...
            observation("portrait", Predicate.NEAR, "P4-S2", object_mention="fireplace", change=ChangeType.MOVE),
